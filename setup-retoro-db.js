...
async function setupDatabase() {
  try {
    ...
    await sql`CREATE INDEX IF NOT EXISTS idx_posts_featured ON posts(featured, published_at DESC)`;
    ...
    await sql`CREATE INDEX IF NOT EXISTS idx_faqs_published ON faqs(published, sort_order ASC)`;
    await sql`CREATE INDEX IF NOT EXISTS idx_faqs_category ON faqs(category, sort_order ASC)`;
    ...
    console.log('\n✅ Retoro database setup complete!');
